...
from distil.scalable_active_learning_strategies.entropy_sampling_dropout import EntropySamplingDropout
from test.utils import MyLabeledDataset, MyUnlabeledDataset

import unittest
import torch

class TestEntropySamplingDropout(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.strategy = EntropySamplingDropout(rand_labeled_dataset, rand_unlabeled_dataset, mymodel, self.classes, args)  
