...
from distil.scalable_active_learning_strategies.margin_sampling_dropout import MarginSamplingDropout
from test.utils import MyLabeledDataset, MyUnlabeledDataset

import unittest
import torch

class TestMarginSamplingDropout(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.strategy = MarginSamplingDropout(rand_labeled_dataset, rand_unlabeled_dataset, mymodel, self.classes, args)  
