...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, channel=1, num_classes=10):
        super(ResNet, self).__init__()
        self.in_planes = 16
        self.embDim = 128 * block.expansion
        self.conv1 = nn.Conv2d(channel, 16, kernel_size=1, stride=1, padding=1, bias=False)
...
# test()
# from .mlpmod import mlpMod
# from .linearmodel import linMod
