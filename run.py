...
from query_strategies import RandomSampling, BadgeSampling, \
                                ...
                                AdversarialBIM, AdversarialDeepFool, ActiveLearningByLearning, FASS
...
elif opts.alg == 'fass': # coreset sampling
    strategy = FASS(X_tr, Y_tr, idxs_lb, net, handler, args)
...
for rd in range(1, NUM_ROUND+1):
    ...
    q_idxs = output
    # print('New selected points ', len(q_idxs))
    r_c = 0
    for q_id in q_idxs:
        if idxs_lb[q_id] == True:
            r_c += 1
    # print('Repeated ', r_c)
    idxs_lb[q_idxs] = True
